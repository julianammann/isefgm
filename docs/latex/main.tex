...
Der \textbf{Geschenke-Manager} wird als datenschutzorientierte, browserbasierte Webanwendung konzipiert und prototypisch umgesetzt. Die Anwendung bündelt Informationen zu Personen, Anlässen, Geschenk\-ideen, vergangene Geschenken und offenen Aufgaben. Sie unterstützt eine rechtzeitige Planung und hilft, unbeabsichtigte Wiederholungen und kurzfristigen Beschaffungsstress zu vermeiden.
...
\midrule
\textbf{Yin Yin Wu-Hanke} & \includegraphics[height=2.4cm]{team_yin.jpg} & Detection Engineer & Frontendentwicklung, Security \\*
\addlinespace
\textbf{Julian Ammann} & \includegraphics[height=2.4cm]{team_julian.jpg} & Senior Full Stack Developer & Frontend- \& Backendentwicklung, \mbox{DevOps}, Systemarchitektur \\*
\addlinespace
\textbf{Anton Hirsch} & \includegraphics[height=2.4cm]{team_anton.jpg} & Studium der Informatik (Bachelor) & Grundlagen in Python, Java, C++, SQL sowie KI-gestützter Recherche und Problemlösung \\*
\addlinespace
\textbf{Kevin Jordan Taghu} & \includegraphics[height=2.4cm]{team_jordan.png} & Data Analyst & Frontendentwicklung, Datenmodellierung, Reporting, Datenvisualisierung, Datenbereinigung \\
\bottomrule
\end{tabularx}
...
\item Geheimnisse, Passwörter und personenbezogene fachliche Testdaten werden nicht im \mbox{Repository} gespeichert.
\end{itemize}
...
\textbf{Julian Ammann} & Technische Leitung und Full-Stack-Entwicklung & Systemarchitektur, Backend- und Frontend\-entwicklung, DevOps, CI/CD, Hosting und technische Integration \\
\textbf{Yin Yin Wu-Hanke} & Security und Frontend\-entwicklung & Planung und Prüfung der Sicherheits- und Datenschutzmaßnahmen innerhalb der vorgesehenen Projekt\-unterlagen. Durchführung von Berechtigungs- und Sicherheitstests sowie Unterstützung bei der Frontendentwicklung \\
\textbf{Anton Hirsch} & Anforderungen, Dokumentation und Testunterstützung & Fachliche Anforderungen, Mitwirkung am Daten\-modell, Projekt- und Personalrisiken, Dokumentation sowie Erstellung und Durchführung fachlicher \mbox{Testfälle} \\
\bottomrule
\end{tabularx}
...
\includegraphics[width=0.5\linewidth]{infra.png}
...
\item \textbf{03.09.2026:} Prüfung des MS-1-Arbeitsstands. Das Team beschloss, das Risikomanagement in drei Bereiche zu gliedern: Projekt- und Personalrisiken, technische Risiken sowie Informationssicherheit und Datenschutz.
\end{itemize}
...
\begin{tabularx}{\linewidth}{@{}l Y p{.2\linewidth} Y Y@{}}
\toprule
